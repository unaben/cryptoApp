import { IFormattedApiRes } from './cryptoData.types';
...
export interface IResponseData {
  ...
  SponsoredData: Array<never> | Array<string> | Array<number>;
  Data: IData[];
...
export interface IApiResponseData {
  cryptoData: IFormattedApiRes[];
  isLoading: boolean;
}

export type ISymbol = 'BTC' | 'USD' | 'EUR';
...
export type IDisplay = Record<ISymbol, IDisplayObject>;
